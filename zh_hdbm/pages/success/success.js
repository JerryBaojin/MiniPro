// zh_hdbm/pages/success/success.js
var app = getApp()
...
Page({
  ...
  tuijian: function (e) {
    ...
    // console.log(that.data.myenroll[index])
    //console.log(e)
    for (var i = 0; i < that.data.myenroll.length; i++) {
      if (that.data.myenroll[i].id == that.data.myenroll[index].id) {
        console.log(that.data.myenroll[i])
        // console.log(that.data.myenroll[index].id)
        wx.navigateTo({
          url: '../info/info?id=' + that.data.myenroll[index].id + '&coll=' + that.data.myenroll[i].cost + '&logo=' + that.data.myenroll[i].logo + '&name=' + that.data.myenroll[i].name + '&created_time=' + that.data.myenroll[i].created_time,
        })
